...
export default function Study(props) {
  ...
  return (
    <article className="flex justify-between rounded px-3 py-2">
      ...
      >
        <button className=" transition-colors duration-100 h-10 w-10 flex justify-center  items-center p-2.5 text-red-500  hover:text-red-600 focus:text-red-600 hover:bg-red-100 focus:bg-red-100 active:bg-red-200 rounded-full cursor-pointer">
